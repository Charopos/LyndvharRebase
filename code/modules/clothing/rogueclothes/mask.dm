...
/obj/item/clothing/mask/rogue/spectacles/inq
	...
	icon_state = "bglasses"
	desc = "Made to both ENDURE and to SEE. The lenses look like they can be brushed aside with a carefully guided right-pointer finger led motion."
	attacked_sound = 'sound/combat/hits/onglass/glasshit.ogg'
	max_integrity = 300
	integrity_failure = 0.5
	resistance_flags = FIRE_PROOF
...
/obj/item/clothing/mask/rogue/facemask/steel/confessor
	name = "strange mask"
	desc = "It is said that the original version of this mask was used for obscure rituals in the early years of the Gilded Age, and now it has been repurposed as a veil for the cunning hand of the Valorian Orthodoxy.<br> <br>Others say it is a piece of heresy, a necessary evil, capable of keeping its user safe from left-handed magicks. You can taste copper whenever you draw breath."
