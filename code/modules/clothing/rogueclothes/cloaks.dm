...
/obj/item/clothing/cloak/psyaltrist
	...
	desc = "A silk stole embroidered with silver fillagree and with concealed pockets in its back worn over a hymnal-scroll. It is worn as the traditional garb of a graduate of the choir leaders of the cathedrals of Valoria and is a symbol of their station."
	slot_flags = ITEM_SLOT_BACK_R|ITEM_SLOT_CLOAK
