...
/datum/species/dullahan/get_skin_list()
	return list(
		...
		"Khazumian" = SKIN_COLOR_KHAZUMIA_BORN,
		"Southern Khazumian" = SKIN_COLOR_KHAZUMIA_LIGHT,
		...
		"Khazumian-Valorian" = SKIN_COLOR_KHAZUMIA_VALORIAN,
		"Grenzel-Khazumian" = SKIN_COLOR_GRENZEL_KHAZUMIAN,
		...
		"Yanshen" = SKIN_COLOR_PALE_YANSHEN,
