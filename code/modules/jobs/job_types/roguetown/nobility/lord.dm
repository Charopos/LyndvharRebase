	...
	if(player.prefs)
		if(!istype(player.prefs.virtue_origin, /datum/virtue/origin/lyndhardt) && !istype(player.prefs.virtue_origin, /datum/virtue/origin/grenzelhoft) && !istype(player.prefs.virtue_origin, /datum/virtue/origin/valoria) && !istype(player.prefs.virtue_origin, /datum/virtue/origin/calmirixia))
			...
			if(choice)
				...
				new_origin = pick(/datum/virtue/origin/grenzelhoft, /datum/virtue/origin/valoria, /datum/virtue/origin/calmirixia)
...
/datum/advclass/lord/inbred
	name = "Inbred Lord"
	tutorial = "Astrata smiles upon you. For despite your inbred and weak body, and your family's conspiracies to remove you from succession, you have somehow become the Viscount of Lyndvhar. May your reign lasts a hundred years."
