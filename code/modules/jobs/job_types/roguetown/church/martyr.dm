...
/datum/job/roguetown/martyr
	...
	virtue_restrictions = list(/datum/virtue/combat/rotcured, /datum/virtue/utility/deadened, /datum/virtue/combat/dualwielder, /datum/virtue/heretic/zchurch_keyholder)
