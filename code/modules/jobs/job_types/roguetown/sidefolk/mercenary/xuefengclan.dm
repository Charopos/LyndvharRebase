...
/datum/outfit/job/roguetown/mercenary/xuefengclan/pre_equip(mob/living/carbon/human/H)
	..()
	to_chat(H, span_warning("You are well versed and experienced in swordfighting, you have no problem in taking up most jobs so long as the coin is good, for either yourself or fellow Xuefeng."))
	belt = /obj/item/storage/belt/rogue/leather
	beltr = /obj/item/rogueweapon/scabbard/sword/yanshen/steel
...
/datum/outfit/job/roguetown/mercenary/xuefengclan_sasu/pre_equip(mob/living/carbon/human/H)
	..()
	H.set_blindness(0)
	to_chat(H, span_warning("You are an archer of the clan, many have called you an true marksman for your skills with the bow. You have no problem in taking up most jobs so long as the coin is good, for either yourself or fellow Xuefeng."))
	belt = /obj/item/storage/belt/rogue/leather
