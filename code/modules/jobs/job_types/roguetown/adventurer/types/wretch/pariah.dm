...
/datum/advclass/wretch/pariah
	...
	traits_applied = list(TRAIT_LYNDNATIVE, TRAIT_OUTDOORSMAN, TRAIT_DODGEEXPERT, TRAIT_ARCYNE_T2, TRAIT_WOODWALKER)
	...
	subclass_languages = list(/datum/language/lyndhardtian)
