/datum/job/roguetown/weocilyn/hand
	title = "Hand of Weocilyn"
	...
	total_positions = 1
	spawn_positions = 0
	job_traits = list(TRAIT_NOBLE, TRAIT_WEOCILYN)
	advclass_cat_rolls = list(CTAG_HFT_HAND)

	job_subclasses = list(
		/datum/advclass/weocilyn/hand/marshal,
		/datum/advclass/weocilyn/hand/steward,
...
/datum/outfit/job/roguetown/weocilyn/hand/marshal/pre_equip(mob/living/carbon/human/H)
	..()
	...
	var/helmet = list("Calmirixia Bascinet","Volf Plate Helmet","Beak Helmet","Visored Sallet",)
...
/datum/outfit/job/roguetown/weocilyn/hand/steward/pre_equip(mob/living/carbon/human/H)
	..()
...
/datum/outfit/job/roguetown/weocilyn/hand/advisor/pre_equip(mob/living/carbon/human/H)
	..()
