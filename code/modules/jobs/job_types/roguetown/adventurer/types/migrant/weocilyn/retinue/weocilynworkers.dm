/datum/advclass/weocilyn/retinue/servant
	name = "Weocilyn Servant"		
	tutorial = "You are Servant of Weocilyn, a Servant of the prosperous borderlands. \
	...
	outfit = /datum/outfit/job/roguetown/weocilyn/retinue/servant
	maximum_possible_slots = 4
	pickprob = 100
	category_tags = list(CTAG_HFT_RETINUE)
	class_select_category = CLASS_CAT_HFT_WORKER
	traits_applied = list(TRAIT_CICERONE, TRAIT_KEENEARS, TRAIT_SLEUTH, TRAIT_HOMESTEAD_EXPERT, TRAIT_SEWING_EXPERT, TRAIT_WEOCILYN)
...
/datum/outfit/job/roguetown/weocilyn/retinue/servant/pre_equip(mob/living/carbon/human/H)
	..()
