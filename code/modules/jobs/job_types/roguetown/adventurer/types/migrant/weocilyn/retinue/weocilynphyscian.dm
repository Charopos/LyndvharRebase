...
/datum/advclass/weocilyn/retinue/physician
	name = "Weocilyn Physician"
	tutorial = "You are the Physician of Weocilyn, celebrated for your steady hands and healing wisdom. \
	...
	traits_applied = list(TRAIT_WEOCILYN, TRAIT_NOSTINK, TRAIT_EMPATH)
...
/datum/outfit/job/roguetown/weocilyn/retinue/physician/pre_equip(mob/living/carbon/human/H)
	..()
