...
/datum/job/roguetown/weocilyn/knight/after_spawn(mob/living/L, mob/M, latejoin = TRUE)
	..()
	if(!ishuman(L))
		return
...
/datum/advclass/weocilyn/knight
	...
	traits_applied = list(TRAIT_NOBLE, TRAIT_HEAVYARMOR, TRAIT_STEELHEARTED, TRAIT_WEOCILYN)
...
/datum/outfit/job/weocilyn/knight/pre_equip(mob/living/carbon/human/H)
	..()
	...
	var/helmet = list("Pigface Bascinet","Guard Helmet","Barred Helmet","Bucket Helmet","Knight's Helmet","Knight's Armet","Volf Plate Helmet" ,"Visored Sallet","Armet","Hounskull Bascinet", "Calmirixian Bascinet", "Slitted Kettle")
