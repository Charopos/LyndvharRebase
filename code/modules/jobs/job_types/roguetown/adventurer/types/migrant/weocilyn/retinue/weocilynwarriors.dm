...
/datum/advclass/weocilyn/retinue/houseguard
	name = "Weocilyn House Guard"
	tutorial = "You are a House Guard for the Lord of Weocilyn, a valiant defender of the prosperous borderlands. \
	...
	outfit = /datum/outfit/job/roguetown/weocilyn/retinue/houseguard
	maximum_possible_slots = 4
	pickprob = 100
	category_tags = list(CTAG_HFT_RETINUE)
	class_select_category = CLASS_CAT_HFT_GUARD
	traits_applied = list(TRAIT_MEDIUMARMOR, TRAIT_STEELHEARTED, TRAIT_WEOCILYN) // MAA footman W/O Guardsman Trait
	subclass_stats = list( //
		STATKEY_STR = 2, 
		STATKEY_WIL = 2,
		STATKEY_SPD = 1,
...
/datum/outfit/job/roguetown/weocilyn/retinue/houseguard/pre_equip(mob/living/carbon/human/H)
	..()
...
// Ranged weapons
/datum/advclass/weocilyn/retinue/housearb
	name = "Weocilyn Missilite"
	tutorial = "You are a Missilite for the Lord of Weocilyn, a ranged combatant of the prosperous borderlands. \
	However, with the increase in banditry, necromancy, deadite risings, and increasing sea raider raids, there are rumors abound that Weocilyn is not what it used to be. \
	Travellers often warn of Weocilyn having fallen already, and words of secretive cultists isn't unheard of."
	allowed_sexes = list(MALE, FEMALE)
	outfit = /datum/outfit/job/roguetown/weocilyn/retinue/housearb
	category_tags = list(CTAG_HFT_RETINUE)
	class_select_category = CLASS_CAT_HFT_GUARD
	traits_applied = list(TRAIT_MEDIUMARMOR, TRAIT_STEELHEARTED, TRAIT_WEOCILYN) // Medium Armor Forced - Heavier 'Defensive' Class
	subclass_stats = list(
		STATKEY_SPD = 2,
		STATKEY_PER = 2,
		STATKEY_LCK = 2	
...
/datum/outfit/job/roguetown/weocilyn/retinue/housearb/pre_equip(mob/living/carbon/human/H)
	..()
...
/datum/advclass/weocilyn/retinue/squire
	name = "Weocilyn Squire"
	tutorial = "You are a Squire for the Knights of Weocilyn, a trainee of the valiant defenders of the prosperous borderlands. \
	However, with the increase in banditry, necromancy, deadite risings, and increasing sea raider raids, there are rumors abound that Weocilyn is not what it used to be. \
	Travellers often warn of Weocilyn having fallen already, and words of secretive cultists isn't unheard of."
	allowed_sexes = list(MALE, FEMALE)
	allowed_races = RACES_SHUNNED_UP
	outfit = /datum/outfit/job/roguetown/weocilyn/retinue/squire
	maximum_possible_slots = 2
	pickprob = 100
	category_tags = list(CTAG_HFT_RETINUE)
	class_select_category = CLASS_CAT_HFT_GUARD
	traits_applied = list(TRAIT_MEDIUMARMOR, TRAIT_SQUIRE_REPAIR, TRAIT_STEELHEARTED, TRAIT_WEOCILYN)
	subclass_stats = list(
		STATKEY_INT = 2,
		STATKEY_PER = 1,
		STATKEY_CON = 2,
...
/datum/outfit/job/roguetown/weocilyn/retinue/squire/pre_equip(mob/living/carbon/human/H)
	..()
