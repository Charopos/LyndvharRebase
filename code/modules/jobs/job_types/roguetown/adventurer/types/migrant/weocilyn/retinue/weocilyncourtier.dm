...
/datum/advclass/weocilyn/retinue/courtier
	name = "Weocilyn Courtier"
	tutorial = "You are a Courtier of Weocilyn, a respected noblewoman looking to impress your lover. \
	...
	outfit = /datum/outfit/job/roguetown/weocilyn/retinue/courtier
...
// HIGH COURT - /ONE SLOT/ Roles that were previously in the Court, but moved here.
	...
	traits_applied = list(TRAIT_SEEPRICES, TRAIT_NOBLE, TRAIT_NUTCRACKER, TRAIT_WEOCILYN)
...
/datum/outfit/job/roguetown/weocilyn/retinue/courtier/pre_equip(mob/living/carbon/human/H)
	..()
