...
/datum/advclass/weocilyn/retinue/armorer
	name = "Weocilyn Armorer"
	tutorial = "You are the Weocilyn Armorer destined for greatness,\
	...
	outfit = /datum/outfit/job/roguetown/weocilyn/retinue/armorer
	maximum_possible_slots = 1
	pickprob = 100
	category_tags = list(CTAG_HFT_RETINUE)
	class_select_category = CLASS_CAT_HFT_WORKER

// Master Smith role for Weocilyn

	traits_applied = list(TRAIT_TRAINED_SMITH, TRAIT_SMITHING_EXPERT, TRAIT_MEDIUMARMOR, TRAIT_WEOCILYN)
	subclass_stats = list(
		STATKEY_LCK = 1,
		STATKEY_STR = 2,
		STATKEY_WIL = 2,
...
/datum/outfit/job/roguetown/weocilyn/retinue/armorer/pre_equip(mob/living/carbon/human/H)
	..()
