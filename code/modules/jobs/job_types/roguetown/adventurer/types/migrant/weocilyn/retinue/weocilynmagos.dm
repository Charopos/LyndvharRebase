...
/datum/advclass/weocilyn/retinue/magos
	name = "Weocilyn Magos"
	tutorial = "You are the Magos of Weocilyn, renowned for your arcane knowledge. \
	...
	outfit = /datum/outfit/job/roguetown/weocilyn/retinue/magos
	maximum_possible_slots = 1
	pickprob = 100
	category_tags = list(CTAG_HFT_RETINUE)
	class_select_category = CLASS_CAT_HFT_COURT

	traits_applied = list(TRAIT_MAGEARMOR, TRAIT_ARCYNE_T3, TRAIT_INTELLECTUAL, TRAIT_ALCHEMY_EXPERT, TRAIT_WEOCILYN)
	subclass_stats = list(
		STATKEY_INT = 2,
		STATKEY_PER = 2,
		STATKEY_WIL = 1,
...
/datum/outfit/job/roguetown/weocilyn/retinue/magos/pre_equip(mob/living/carbon/human/H)
	..()
