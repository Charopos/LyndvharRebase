...
/datum/advclass/weocilyn/retinue/jester
	name = "Weocilyn Jester"
	tutorial = "You are the Jester of Weocilyn, a bringer of laughter in brighter days. \
	...
	outfit = /datum/outfit/job/roguetown/weocilyn/retinue/jester
	maximum_possible_slots = 1
	pickprob = 100
	category_tags = list(CTAG_HFT_RETINUE)
	class_select_category = CLASS_CAT_HFT_COURT
	traits_applied = list(TRAIT_ZJUMP, TRAIT_LEAPER, TRAIT_NUTCRACKER, TRAIT_NOFALLDAMAGE1, TRAIT_WEOCILYN)

// HIGH COURT - /ONE SLOT/ Roles that were previously in the Court, but moved here.

/datum/outfit/job/roguetown/weocilyn/retinue/jester/pre_equip(mob/living/carbon/human/H)
	..()
	...
	H.STASTR = rand(3, 20) //Slightly better odds for a Weocilyner AKA a migrant
	H.STAWIL = rand(3, 20)
	H.STACON = rand(3, 20)
	H.STAINT = rand(3, 20)
	H.STAPER = rand(3, 20)
