...
/datum/supply_pack/rogue/alcohol/rhaenvalmead
	name = "Ragnars Mead"
	cost = 25
	contains = list(/obj/item/reagent_containers/glass/bottle/rogue/beer/rhaenvalmead)
...
/datum/supply_pack/rogue/alcohol/vruiridrice
	name = "Makkolir (Vruirid Rice Wine)"
	cost = 30
	contains = list(/obj/item/reagent_containers/glass/bottle/rogue/beer/vruiridrice)
