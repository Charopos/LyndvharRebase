...
/datum/reagent/consumable/ethanol/rhaenvalmead
	name = "Ragnar's Brew"
	boozepwr = 35
...
/datum/reagent/consumable/ethanol/vruiridrice
	name = "Makkolir"
	boozepwr = 30
...
/datum/reagent/consumable/ethanol/saigamilk //No way, kumys from vruirid!!!
	name = "Bökhiin Arkhi"
	boozepwr = 15
...
/datum/reagent/consumable/ethanol/whipwine // dont ask
	...
	description = "A recipe recently floated into the streets of Lyndvhar. Magickal Whip Wine is said to increase one's potence and stamina sevenfold."
...
/datum/reagent/consumable/ethanol/komuchisake // if you put this outside the lich dungeon i'll kill you
	...
	description = "The True Form of the Whipwine. The Magickal Snake Wine was an exclusively produced medicinal wine from over three centures ago in the Yanshen territories."
