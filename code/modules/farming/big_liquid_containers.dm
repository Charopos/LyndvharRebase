...
/obj/structure/fermentation_keg/redwine
	desc = "A barrel that contains a Valorian luxury. It was originally served as part of Psydonic communion, eventually becoming wildly enjoyed within Valoria to the point of being oft paired with EVERY meal."
...
/obj/structure/fermentation_keg/vruiridrice/Initialize()
	. = ..()
	reagents.add_reagent(/datum/reagent/consumable/ethanol/vruiridrice,900)
