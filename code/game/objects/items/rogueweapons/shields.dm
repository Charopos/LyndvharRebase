...
/obj/item/rogueweapon/shield/tower/zybantu
	name = "rider shield"
	desc = "A shield of Zybantu design. Clever usage of wood, iron, and leather make an impressive match for any weapon."
...
/*/obj/item/rogueweapon/shield/buckler/freelancer
	name = "fencer's wrap"
	desc = "A traditional Calmirixian quilted cloth square with a woolen cover. It can be used to daze and distract people with its bright colours and hanging steel balls."
	force = 10
	throwforce = 10
	coverage = 15
	max_integrity = 200
