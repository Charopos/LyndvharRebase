...
/obj/item/rogue/instrument/shamisen
	name = "shamisen"
	desc = "The shamisen, or simply «three strings», is a Yansheneze stringed instrument with a washer, which is usually played with the help of a bachi."
	icon_state = "shamisen"
...
/obj/item/rogue/instrument/psyaltery
	...
	"Ruby Fair" = 'sound/music/instruments/psyaltery (6).ogg',
	...
	"Chevalier de Valoria" = 'sound/music/instruments/psyaltery (10).ogg')
