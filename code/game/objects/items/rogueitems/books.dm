...
/obj/item/book/rogue/bibble
	...
	desc = "The collected verses and acts of the DIVINE PANTHEON. Split into three parts.</br>VISAGE - The OLD, THE FIRST ACTS OF THE TEN UPON BEOWRICKE </br>DECANOMICON - THE ERA OF GLEAM, THE HOLY CELESTIAL EMPIRE - </br>NEW DAWN - Modern Era, the foundation of the HOLY SEE and ONWARDS."
	icon_state = "bibble_0"
...
/obj/item/book/rogue/bibble/psy
	name = "Tome of Psydon"
	desc = "'And HE WEEPS. Not for you, not for me, but for it all.' </br>A leatherbound tome, chronicling the beliefs held by the Orthodoxy; the largest Psydonic denomination in the world. The 'Harlaus Press', a recent invention by Valoria's clergymen, has ensured that no corner of Beowricke would remain unlit by His teachings. Inside are three seperate testaments, each marked with a velvet strap.. </br>PSALMS - TESTAMENTS OF CLERICAL WISDOM, COMMANDING INTERPRETATION. </br>GENESIS - TESTAMENTS OF BEOWRICKE'S CREATION, FOR WHAT ONCE WAS. </br>INVOCATIONS - TESTAMENTS OF WILL, TO EXORCISE AND CHANT."
	icon_state = "psyble_0"
...
/obj/item/book/rogue/tales3
	name = "Myths & Legends of Beowricke Volume I"
...
/obj/item/book/rogue/lyndvharhistory
	name = "Documented History of Lyndvhar"
	desc = "By Loracyne Muthesceri, Archmage of the Eyrie"
	icon_state = "knowledge_0"
	base_icon_state = "knowledge"
	bookfile = "lyndvharhistory.json"

/obj/item/book/rogue/splitsternpirates
	name = "Pirates of the Splitstern"
	desc = "By Arthur von Gutenberg, Esq"
	icon_state = "book8_0"
	base_icon_state = "book8"
	bookfile = "splitsternpirates.json"

/obj/item/book/rogue/thebloodwake
	name = "The Bloodwake"
	desc = "By Loracyne Muthesceri, Archmage of the Eyrie"
	icon_state = "book7_0"
	base_icon_state = "book7"
	bookfile = "thebloodwake.json"

/obj/item/book/rogue/eyrierecords
	name = "Eyrie Records"
	desc = "Kelceran Amberheel, Royal Archivist of Aevislan"
	icon_state = "book6_0"
	base_icon_state = "book6"
	bookfile = "eyrierecords.json"
