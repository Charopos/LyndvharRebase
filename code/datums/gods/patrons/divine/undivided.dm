/datum/patron/divine/undivided
	name = "Undivided"
	domain = "All Aspects of Life Everlasting"
	desc = "The primary form of worship being a generalist approach to worshipping all Ten, and taking lessons from all. This is the primary theology of clergy in the Mother Church."
