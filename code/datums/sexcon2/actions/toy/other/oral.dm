...
/datum/sex_action/toy/other/oral/on_start(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
	show_sex_message(user, target, span_warning("[user] slides a dildo into [target]'s mouth!"))
...
/datum/sex_action/toy/other/oral/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	...
	show_sex_message(user, target, sex_session.spanify_force("[user] [sex_session.get_generic_force_adjective()] fucks [target]'s throat with a dildo!"))
...
/datum/sex_action/toy/other/oral/on_finish(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
	show_sex_message(user, target, span_warning("[user] pulls [user.p_their()] dildo from [target]'s mouth."))
