...
/datum/sex_action/toy/anus/on_start(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
	show_sex_message(user, target, span_warning("[user] starts riding a dildo using [user.p_their()] butt..."))
...
/datum/sex_action/toy/anus/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	...
	show_sex_message(user, target, sex_session.spanify_force("[user] [sex_session.get_generic_force_adjective()] fucks [user.p_their()] butt with a dildo!"))
...
/datum/sex_action/toy/anus/on_finish(mob/living/carbon/human/user, mob/living/carbon/human/target)
	. = ..()
	show_sex_message(user, target, span_warning("[user] stops fucking [user.p_their()] butt with a dildo."))
