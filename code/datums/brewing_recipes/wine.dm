...
/datum/brewing_recipe/whipwine
	name = "Wine, Whip"
	category = "Other"
	bottle_name = "lyndvhar whip-wine" // knockoff divine whip wine (magical penis wine)
	bottle_desc = "A bottle of locally-brewed Whipwine. Said to be based off a foreign Yanshen recipe. It has a particularly... leathery flavor."
