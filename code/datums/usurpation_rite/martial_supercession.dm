...
<p><b>Realm type if successful:</b> Sovereign Order, ruled by an Autocrat.</p>"}
	new_ruler_title = "Autocrat"
	new_ruler_title_f = "Autocrat"
	...
	roundend_epilogue = "The realm has been seized by the strong, " + \
		...
		"But will this new Autocrat be able to defend the realm against its enemies, " + \
