...
/proc/parsemarkdown_basic_step1(t, limited=FALSE, barebones=FALSE, hyperlink = FALSE)
	if(length(t) <= 0)
		return
...
/proc/parsemarkdown_basic_step2(t, hyperlink)
	if(length(t) <= 0)
		return
...
/proc/parsemarkdown_basic(t, limited=FALSE, barebones = FALSE, hyperlink = FALSE)
	t = parsemarkdown_basic_step1(t, limited, barebones, hyperlink)
