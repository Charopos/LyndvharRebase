...
#define TRAIT_INQUISITION "Valorian Adherent"
#define TRAIT_CLERGY "Clergyman"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_WOODSMAN = span_info("I am vigilant in my duties. In the groves and coastlines of Lyndvhar, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_INQUISITION = span_info("I serve the Valorian Inquisition. From a passing glance, I can recognize all other adherents within the local sect."),
	...
	TRAIT_HERESIARCH = span_warning("I've been touched by the truth of Beowricke. Lyfe as we understand cannot persist under the Ten or the pretense of Psydon. Something must change."),
