...
#define LARGER_PENIS_SIZE 4
#define LARGEST_PENIS_SIZE 5
...
#define LARGER_TESTICLES_SIZE 4
#define LARGEST_TESTICLES_SIZE 5

#define TESTICLE_SIZES list(\
	MIN_TESTICLES_SIZE,\
	DEFAULT_TESTICLES_SIZE,\
	LARGE_TESTICLES_SIZE,\
	LARGER_TESTICLES_SIZE,\
	LARGEST_TESTICLES_SIZE,\
	)
