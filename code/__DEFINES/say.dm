...
#define SPAN_GREENCREST "aeltharyn"
#define SPAN_UNDEAD "undead"
#define SPAN_CAT "cat"		 //nyi but file found
#define SPAN_PULSEDEATH "pulsedeath"

#define LANGUAGE_SPANS list(SPAN_GEN,SPAN_ORATOR, SPAN_DWARF, SPAN_ABYSS, SPAN_ELF, SPAN_SAND, SPAN_DELF, SPAN_HELL, SPAN_GRENZELHOFTIAN, SPAN_VALORIAN, SPAN_CALMIRIXIAN, SPAN_RHAENISH, SPAN_BEAST, SPAN_ORC, SPAN_DRACONIC, SPAN_YANSHENEZE, SPAN_GREENCREST, SPAN_UNDEAD, SPAN_CAT, SPAN_PULSEDEATH, SPAN_LYNDHARDTIAN, SPAN_FORVHEIPAL, SPAN_ZYBANTI, SPAN_SAND)
