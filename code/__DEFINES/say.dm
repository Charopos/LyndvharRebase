...
#define SPAN_CALMIRIXIAN "calmirixian"
#define SPAN_RHAENISH "rhaenish"
#define SPAN_LYNDHARDTIAN "lyndhardtian"
#define SPAN_BEAST "beast"
#define SPAN_ORC "orc"
#define SPAN_DRACONIC "reptile"
#define SPAN_YANSHENEZE "yansheneze"
...
#define LANGUAGE_SPANS list(SPAN_GEN,SPAN_ORATOR, SPAN_DWARF, SPAN_ABYSS, SPAN_ELF, SPAN_SAND, SPAN_DELF, SPAN_HELL, SPAN_GRENZELHOFTIAN, SPAN_VALORIAN, SPAN_CALMIRIXIAN, SPAN_RHAENISH, SPAN_BEAST, SPAN_ORC, SPAN_DRACONIC, SPAN_YANSHENEZE, SPAN_AAVNIC, SPAN_UNDEAD, SPAN_CAT, SPAN_PULSEDEATH, SPAN_LYNDHARDTIAN)
