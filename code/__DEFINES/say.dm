...
#define LANGUAGE_SPANS list(SPAN_GEN,SPAN_ORATOR, SPAN_DWARF, SPAN_ABYSS, SPAN_ELF, SPAN_SAND, SPAN_DELF, SPAN_HELL, SPAN_GRENZELHOFTIAN, SPAN_VALORIAN, SPAN_CALMIRIXIAN, SPAN_GRONNIC, SPAN_BEAST, SPAN_ORC, SPAN_DRACONIC, SPAN_KAZENGUNESE, SPAN_AAVNIC, SPAN_UNDEAD, SPAN_CAT, SPAN_PULSEDEATH, SPAN_LYNDHARDTIAN)
